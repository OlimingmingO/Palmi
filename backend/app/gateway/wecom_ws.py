# TODO: Adapt for Palmi multi-tenant routing
# ---------------------------------------------------------------------------
# REFERENCE COPY from Hermes Agent gateway/platforms/wecom.py (65KB)
# Copied for Phase 1 WebSocket stability testing — NOT adapted yet.
# Do NOT import from this module; it still references Hermes internals.
# ---------------------------------------------------------------------------
"""
